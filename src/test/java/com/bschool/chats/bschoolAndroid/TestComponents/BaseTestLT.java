...
public class BaseTestLT {
	...
	public AndroidDriver initializeDriver(String deviceName) throws URISyntaxException, IOException
	{
		...
		//Path to apk file
				...
				String userName = System.getenv("LT_USERNAME") == null ? "milestuck95" // Add username here
			            : System.getenv("LT_USERNAME");
			    String accessKey = System.getenv("LT_ACCESS_KEY") == null ? "Sqd8lYkALMXgDM1JUMLkrwZO1G13oT9n61SkuD9hjWbgqX31ni" // Add accessKey here
			            : System.getenv("LT_ACCESS_KEY");
			    
			    /*String APP_URL= "https://milestuck95:Sqd8lYkALMXgDM1JUMLkrwZO1G13oT9n61SkuD9hjWbgqX31ni@mobile-hub.lambdatest.com/wd/hub"
				...
				//driver = new AndroidDriver (new URL("https://" + userName + ":" + accessKey + "@mobile-hub.lambdatest.com/wd/hub"),
	              //      capabilities);
	            
	            //driver = new AndroidDriver(new URI("http://127.0.0.1:4723/").toURL(), cap);
				
				driver = new AndroidDriver(new URI("https://" + userName + ":" + accessKey + "@mobile-hub.lambdatest.com/wd/hub").toURL(),capabilities);
